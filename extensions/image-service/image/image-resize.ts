 ...
 *
 * Ported literally from @mariozechner/pi-coding-agent/src/utils/image-resize.ts.
 ...
 *  import it directly here. The structural fields used internally are
 *  `mimeType` and `data` (base64). */
