...
| Variable                           | What it is                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `rpc.call(targetId, method, args, options?)` | Portable RPC client, same shape as panels/workers. Raw server services target `"main"`: `await rpc.call("main", "vcs.status", [{ contextId: ctx.contextId }])`. An exact remote workspace is selected with `{ destination: { kind: "workspace", workspaceId } }`; omission stays local.                                                                                                                                                                                                                                                  |
...
gives the full portable client. `import { rpc } from "@workspace/runtime"` uses
`rpc.call(targetId, method, args, options?)` (the ambient `rpc` is 2-arg sugar
