...
export const EXPLORER_SYSTEM_PROMPT = [
  ...
  "6. `notify` a concise summary back to this channel (counts + top findings + file path).",
  "",
  ...
  "addressed or running a scheduled sweep; speaking is an explicit `notify` tool call. One focused",
